...
// it is much more efficient to use an S2EdgeCrosser (see s2edge_crosser.h).
    GT_API int CrossingSign(const S2Point& a, const S2Point& b,
...
// It is an error to call this method with 4 distinct vertices.
    GT_API bool VertexCrossing(const S2Point& a, const S2Point& b,
                    const S2Point& c, const S2Point& d);
...
// by simply counting edge crossings.
    GT_API bool EdgeOrVertexCrossing(const S2Point& a, const S2Point& b,
                          const S2Point& c, const S2Point& d);
...
// very small angle.  See "kIntersectionError" below for details.
    GT_API S2Point GetIntersection(const S2Point& a, const S2Point& b,
                        const S2Point& c, const S2Point& d);
