...
public:
    ...
    // CellIDs are considered to be closed sets.  The returned cell will
    // always contain the given point, i.e.
    //
    //   S2Cell(CellId(p)).Contains(p)
    //
